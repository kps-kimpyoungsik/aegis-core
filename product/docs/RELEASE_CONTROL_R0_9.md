...
- Main also contains separately owned R0.8 live PostgreSQL/Redis storage evidence and the R0.9 recovery/migration semantic integration gate; this candidate consumes those baselines without redefining ownership.
...
7. Recovery/migration semantic ownership remains with runtime-kernel/data-plane; this change does not duplicate it.
...
Rollback Point: `main@8146dec85ee18de978e9dc5660584354296e2175`
