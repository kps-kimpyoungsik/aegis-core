...
javac -d "$OUT" \
  ...
  "$ROOT/integration-gate/src/test/java/aegis/integration/SessionBaselineIntegrationGateTest.java"

java -cp "$OUT" aegis.integration.SessionBaselineIntegrationGateTest
